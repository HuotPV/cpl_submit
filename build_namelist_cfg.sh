...
!          !                                       !  (if <0  months)  !   name    !   (logical)  !  (T/F) ! 'monthly' ! filename ! pairing  ! filename      !
    sn_tem  = 'start025.nc',         -12        ,'votemper' ,    .true.    , .true. , 'yearly'  ,'',   ''     ,    ''
    sn_sal  = 'start025.nc'       ,         -12        ,'vosaline' ,    .true.    , .true. , 'yearly'  ,'',   ''     ,    ''
!
...
! for lim3
   ...
   cn_dir  =    '/scratch/ucl/elic/phuot/CPL_ade025_mar/'
   ln_full_vel = .false.
/
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
   ...
   rn_ahm_0_blp     =   -1.25e10    !  horizontal bilaplacian eddy viscosity [m4/s] -1.25e10
   ...
   rn_ahm_m_blp     =   -1.25e10 !  upper limit for bilap  abs(ahm) < min( dx^4/128rdt, rn_ahm_m_blp)
